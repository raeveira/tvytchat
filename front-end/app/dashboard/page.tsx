    ...
    return (
        <div className={'flex flex-row items-center justify-center h-screen w-screen'}>
            <div className="text-[2rem] font-bold text-center flex-1">
                <div>
                    Auth:
                    <a href={'http://localhost:3000/api/auth/twitch'} className={'text-blue-500 hover:underline'}>
                        Twitch
                    </a>
                    <a href={'http://localhost:3000/api/auth/youtube'} className={'text-red-500 hover:underline'}>
                        YouTube
                    </a>
                </div>
            </div>
